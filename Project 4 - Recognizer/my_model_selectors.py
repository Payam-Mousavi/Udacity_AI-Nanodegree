...
class SelectorBIC(ModelSelector):
    ...
    def BICScore(self, N):
        """
            Evaluates and returns the BIC Score
        """
...
class SelectorDIC(ModelSelector):
    ...
    def DICScore(self, N):
        ''' Evaluates and returns the DIC score -- Note that I'm using the
        for evaluation and not the provided formula'''
        model, scores = self.base_model(N), []
...
class SelectorCV(ModelSelector):
    ...
    def cvScore(self, N):
        ...
        for train_ind, test_ind in split_method.split(self.sequences):
            self.X, self.lengths = combine_sequences(train_ind,self.sequences)
            model = self.base_model(N)
            X, l = combine_sequences(test_ind, self.sequences)
