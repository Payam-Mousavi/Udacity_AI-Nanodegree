...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        """
        previous_sl = self.s_levels[level]
        ...
        for act in actions:
            ...
            if act_node.prenodes.issubset(previous_sl):
                for state_node in previous_sl:
    ...
    def add_literal_level(self, level):
        ...
        """
        prev_act_level = self.a_levels[level - 1] 
        self.s_levels.append(set()) # Initialize this level of states
        for act_node in prev_act_level:
            for eff_node in act_node.effnodes:
                act_node.children.add(eff_node)
                eff_node.parents.add(act_node)
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        check_1 = set(node_a1.action.effect_add) & set(node_a2.action.effect_rem)
        check_2 = set(node_a2.action.effect_add) & set(node_a1.action.effect_rem)
        return bool(check_1 | check_2)
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # Action in node 1 vs. precondition of node 2:
        check_act1_prec2_1 = set(node_a1.action.effect_add) & set(node_a2.action.precond_neg)
        check_act1_prec2_2 = set(node_a1.action.effect_rem) & set(node_a2.action.precond_pos)
        check_act1_prec2 = check_act1_prec2_1 | check_act1_prec2_2
        # Action in node 2 vs. precondition of node 1:
        check_act2_prec1_1 = set(node_a2.action.effect_add) & set(node_a1.action.precond_neg)
        check_act2_prec1_2 = set(node_a2.action.effect_rem) & set(node_a1.action.precond_pos)
        check_act2_prec1 = check_act2_prec1_1 | check_act2_prec1_2
        
        return bool(check_act1_prec2 | check_act2_prec1)
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        :return: bool
        """
        # Checking that both states have the same symbol AND one is the negation of the other
    ...
    def h_levelsum(self) -> int:
        ...
        for g in goals:
            ...
            for level in range(len(s_levels)):
                s_nodes = s_levels[level]
                if node in s_nodes:
                    level_sum += level
                    break
        return level_sum
